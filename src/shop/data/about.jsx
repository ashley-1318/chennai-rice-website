...
export const CTA = {
  ...
  // Adapted for this site's routes (the upstream repo's own "/" is a
  // standalone products page and its mailto isn't wired to this app's
  // /contact form) — everything else here is the upstream copy verbatim.
  primary: { label: "Explore Our Rice", to: "/products" },
