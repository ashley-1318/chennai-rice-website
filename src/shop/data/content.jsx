...
export const MILESTONES = [
  { year: "1980", side: 1,  tone: "maroon", icon: ICON_MILL,    photo: "/assets/shop/journey/1980-vision.jpg",   fallback: "/assets/shop/journey/mill.svg",     label: "Photo: the first mill",                    text: "A vision to establish modern rice mills." },
  { year: "1980", side: -1, tone: "gold",   icon: ICON_MILL,    photo: "/assets/shop/journey/1980-unit1.jpg",    fallback: "/assets/shop/journey/mill.svg",     label: "Photo: Production Unit 1",                 text: "Production Unit‑1 was established by the founder." },
  { year: "1999", side: 1,  tone: "maroon", icon: ICON_MILL,    photo: "/assets/shop/journey/1999-unit2.jpg",    fallback: "/assets/shop/journey/mill.svg",     label: "Photo: Production Unit 2",                 text: "Production Unit‑2 was established." },
  { year: "2003", side: -1, tone: "gold",   icon: ICON_MILL,    photo: "/assets/shop/journey/2003-unit3.jpg",    fallback: "/assets/shop/journey/mill.svg",     label: "Photo: Production Unit 3",                 text: "Production Unit‑3 was established by the founder." },
  { year: "2008", side: 1,  tone: "maroon", icon: ICON_LEAF,    photo: "/assets/shop/journey/2008-upgrade.jpg",  fallback: "/assets/shop/journey/upgrade.svg",  label: "Photo: the high-tech stake unit",          text: "Upgraded with a high-tech stake unit. The facility now boasts a paddy processing capacity of up to 190 tonnes per day, a pioneering feat in Tamil Nadu." },
  { year: "2010", side: -1, tone: "gold",   icon: ICON_SILO,    photo: "/assets/shop/journey/2010-storage.jpg",  fallback: "/assets/shop/journey/silo.svg",     label: "Photo: the storage silos",                 text: "Uplifted with storage capacity of 35,000 MT." },
  { year: "2013", side: 1,  tone: "maroon", icon: ICON_TURBINE, photo: "/assets/shop/journey/2013-energy.jpg",   fallback: "/assets/shop/journey/energy.svg",   label: "Photo: the wind and solar installation",    text: "Incorporated 3 MW green energy into our production process through wind, solar, and turbine technologies." },
  { year: "2020", side: -1, tone: "gold",   icon: ICON_SILO,    photo: "/assets/shop/journey/2020-storage.jpg",  fallback: "/assets/shop/journey/silo.svg",     label: "Photo: the added storage",                 text: "Add-on storage capacity of 25,000 MT." },
  { year: "2021", side: 1,  tone: "maroon", icon: ICON_PARK,    photo: "/assets/shop/journey/2021-foodpark.jpg", fallback: "/assets/shop/journey/foodpark.svg", label: "Photo: the food park",                     text: "Develops a food park under the APC scheme by MOFPI." },
  { year: "2021", side: -1, tone: "gold",   icon: ICON_STAR,    photo: "/assets/shop/journey/2021-largest.jpg",  fallback: "/assets/shop/journey/award.svg",    label: "Photo: the plant today",                   text: "Achieving 600 metric tons of paddy processing, the company has become the largest rice manufacturer in Tamil Nadu." }
];
