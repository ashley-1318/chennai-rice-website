 ...
 *
 * Both buttons route within this app (see data/about.jsx) — the upstream
 * repo's secondary button was a bare mailto, but this site already has a
 * working /contact page, so that's what "Contact Us" points to here.
 */
    ...
    <section className="ab-cta" aria-labelledby="cta-heading" id="contact">
      ...
      <div className="ab-cta-inner">
        ...
        <div className="ab-buttons reveal d3">
          ...
          <Link className="ab-btn ab-btn--ghost" to={CTA.secondary.to}>
            {CTA.secondary.label}
          </Link>
        </div>
      </div>
